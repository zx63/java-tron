...
public class KademliaTest {
  ...
  public void test4() {
    ...
    assertEquals(t.getBucketsCount(), 0);
    ...
    assertEquals(t.getBuckets()[0].getNodesCount(), KademliaOptions.BUCKET_SIZE - 1);
  }
  ...
  /**
   * Generate test node table by quantity.
   */
    ...
    for (NodeBucket b : t.getBuckets()) {
      if (b.getNodesCount() > 0) {
        System.out.println(String
            .format("Bucket %d nodes %d depth %d", b.getDepth(), b.getNodesCount(), b.getDepth()));
      }
    }
  }

  /**
   * Node table contains node.
   */
